(function() {
  ...
  var defaultEncode = pomelo.encode = function(reqId, route, msg) {
    ...
    if((protobuf || decodeIO_encoder) && (clientProtos[route] || decodeIO_encoder.lookup(route))) {
      if(!!protobuf) {
  ...
  var deCompose = function(msg){
    ...
    if((protobuf || decodeIO_decoder) && (serverProtos[route] || decodeIO_decoder.lookup(route))) {
      if(!!protobuf) {
